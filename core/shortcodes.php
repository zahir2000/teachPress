...
function tp_publist_shortcode ($args) {
    ...
    $search_button = '<button type="submit" class="tp_search_button" tabindex="10">
        <svg class="qodef-svg--search" xmlns="http://www.w3.org/2000/svg" width="18.8146" height="17.8887" viewBox="0 0 18.8146 17.8887">
        <path d="M7.5 1A6.5 6.5 0 1 1 1 7.5 6.5074 6.5074 0 0 1 7.5 1m0-1A7.5 7.5 0 1 0 15 7.5 7.5 7.5 0 0 0 7.5 0Z" fill="currentColor"></path>
        <path fill="none" stroke="currentColor" stroke-miterlimit="10" d="M12.1786 12.3837 18.5 17.5"></path>
        </svg>
    ' . __('', 'teachpress') . '</button>';
    #$search_button = '<div class="teachpress_search_button"><input name="tps_button" class="tp_search_button" type="submit" tabindex="10" value="' . __('Search', 'teachpress') . '"/></div>';
